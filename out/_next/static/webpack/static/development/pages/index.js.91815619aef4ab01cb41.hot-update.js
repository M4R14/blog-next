...
var Post = function Post(_ref) {
  ...
  var contentHtml = function contentHtml() {
    ...
    var original_title = root.querySelector('h1');
    var title = root.querySelector('h1');
    title.set_content("<a href=\"".concat("" + "/posts/".concat(params.id), "\" >").concat(title.innerHTML, "</a>"));
    console.log('contentHtml', original_title.toString(), root.querySelector('h1').toString());
    return params.contentHtml.replace(original_title.toString(), title.toString());
  };
...
//# sourceMappingURL=index.js.91815619aef4ab01cb41.hot-update.js.map