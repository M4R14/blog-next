...
var Post = function Post(_ref) {
  ...
  var contentHtml = function contentHtml() {
    ...
    root.querySelector('h1').set_content("<a href=\"".concat("" + "/posts/".concat(params.id), "\" >").concat(title.innerHTML, "</a>"));
    console.log('contentHtml', root.querySelector('h1').toString());
    return params.contentHtml.replace();
  };
...
//# sourceMappingURL=index.js.a0423bc51662cc78eaa8.hot-update.js.map