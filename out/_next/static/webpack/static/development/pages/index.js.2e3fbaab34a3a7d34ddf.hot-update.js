...
var Post = function Post(_ref) {
  ...
  var contentHtml = function contentHtml() {
    ...
    var h1 = root.querySelector('h1').set_content("<a href=\"".concat("" + "/posts/".concat(params.id), "\" >").concat(title, "</a>"));
    console.log('contentHtml', h1);
...
//# sourceMappingURL=index.js.2e3fbaab34a3a7d34ddf.hot-update.js.map