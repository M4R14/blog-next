...
var Post = function Post(_ref) {
  ...
  var contentHtml = function contentHtml() {
    ...
    var title = root.querySelector('h1').innerHTML;
    root.querySelector('h1').set_content("<a href=\"".concat("" + "/posts/".concat(params.id), "\" >").concat(title, "</a>"));
    console.log('contentHtml', root.querySelector('h1').toString());
    return params.contentHtml;
  };
...
//# sourceMappingURL=index.js.ad9da69285751c24b660.hot-update.js.map